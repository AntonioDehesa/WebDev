...
app.get("/", function(req,res)
{
  Post.find({}, function (err, foundPosts) {
    ...
    if(err)
    {
      console.log("Errors found while trying to get the posts in the DB");
      console.log(err);
    }
    else
    {
...
app.get("/posts/:postId", function (req,res) 
{
  ...
  Post.findOne({_id: requestedPostId}, function(err, foundPost){
    if(err)
    {
      console.log("Error while looking for post in /posts/:post");
      console.log(err);
    }
    else
    {
      if(foundPost)
      {
        res.render("post", {Title: foundPost.title, Post: foundPost.content});
      }
      else
      {
        res.render("post",{Title: "Not found", Post: ""});
      }
    }
  });
});
